function main(newConfig = {}) {
  ...
  newConfig["rule-providers"] = {
    ...
    "telegram_ip": createProvider("http", "ipcidr", "mrs", "https://github.com/MetaCubeX//meta-rules-dat/raw/refs/heads/meta/geo-lite/geoip/telegram.mrs"),
    "telegram_domain": createProvider("http", "domain", "mrs", "https://github.com/MetaCubeX//meta-rules-dat/raw/refs/heads/meta/geo-lite/geosite/telegram.mrs"),
    "ablock_domain": createProvider("http", "classical", "yaml", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/ablock.yaml"),
    "adblock_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/adblock.mrs"),
    "media_domain": createProvider("http", "domain", "mrs", "https://github.com/DustinWin/ruleset_geodata/releases/download/mihomo-ruleset/media.mrs"),
    "ai_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/ai.mrs"),
    "google_domain": createProvider("http", "domain", "mrs", "https://github.com/QuixoticHeart/rule-set/raw/refs/heads/ruleset/meta/domain/google.mrs"),
    "google_fcm_domain": createProvider("http", "domain", "mrs", "https://github.com/QuixoticHeart/rule-set/raw/refs/heads/ruleset/meta/domain/googlefcm.mrs"),
    "google_cn_domain": createProvider("http", "domain", "mrs", "https://github.com/DustinWin/ruleset_geodata/releases/download/mihomo-ruleset/google-cn.mrs"),
    "twitter_domain": createProvider("http", "domain", "mrs", "https://github.com/MetaCubeX//meta-rules-dat/raw/refs/heads/meta/geo-lite/geosite/twitter.mrs"),
    "github_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/github.mrs"),
    "pixiv_domain": createProvider("http", "domain", "mrs", "https://github.com/MetaCubeX/meta-rules-dat/raw/refs/heads/meta/geo-lite/geosite/pixiv.mrs"),
    "bytedance_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/bytedance.mrs"),
    "proxy_emby_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/proxy_emby.mrs"),
    "direct_emby_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/direct_emby.mrs"),
    "bilibili_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/bilibili.mrs"),
    "cn_domain": createProvider("http", "domain", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/cn.mrs"),
    "cn_ip": createProvider("http", "ipcidr", "mrs", "https://github.com/Harrykane-der/rule-conversion/raw/refs/heads/release/cn_ip.mrs"),
